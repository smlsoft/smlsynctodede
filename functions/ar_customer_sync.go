...
func SyncArCustomerToMongoDB(database models.DatabaseModel, apiKey string) error {
	...
	for i := 0; i < totalItems; i += batchSize {
		...
		responseBody, err := myglobal.SendDataToAPI("debtor", apiKey, batch)
		if err != nil {
